...
from config import (DOMOTICZ_GET_ALL_DEVICES_URL, U_NAME_DOMOTICZ, U_PASSWD_DOMOTICZ, DOMOTICZ_GET_SETTINGS_URL,
    ...
    TYPE_LIGHT, TYPE_LOCK, TYPE_SCENE, TYPE_SWITCH, TYPE_VACUUM, TYPE_DOOR,TYPE_MEDIA, TYPE_SPEAKER,
    TYPE_THERMOSTAT, TYPE_FAN, TYPE_BLINDS, TYPE_SCREEN, TYPE_SECURITY, TYPE_OUTLET,
